                            ...
                            <div class="col-xl-8 col-md-8">
                                    <h4>Account Setting</h4>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <input type="email" name="email" class="form-control" placeholder="john@gmail.com" value="{{$billing->email}}">
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <label class="form-label">City</label>
                                                    <select class="form-select" name="city" aria-label="Default select example">
                                                        <option disabled {{ $billing->city == null ? 'selected' : '' }}>
                                                            Select your City
                                                        </option>
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <label class="form-label">State</label>
                                                    <select class="form-select" name="state" aria-label="Default select example" value="{{$billing->email}}">
