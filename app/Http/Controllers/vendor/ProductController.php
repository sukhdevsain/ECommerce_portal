...
class ProductController extends Controller
{
    ...
    public function updateproduct(Request $request, $p_id){
        ...
        return redirect('vendor/view-product')->with('success', 'Product updated successfully!');
    }

    public function deleteproduct($p_id){
        $product = Product::find($p_id);
        $product->delete();
        return redirect('vendor/view-product')->with('success', 'Product deleted successfully!');
    }
